...
class SnakeGame extends StatefulWidget {
  SnakeGame({Key? key, required this.size}) : super(key: key);
...
class _SnakeGameState extends State<SnakeGame> {
  ...
  void _buildWalls() {
    ...
    final hWidth =
        GridInfo.getGridlength(gridExcess: gridInfo!.hGridCount! ~/ 3);
    final vWidth =
        GridInfo.getGridlength(gridExcess: gridInfo!.vGridCount! ~/ 3);
...
class GameScene extends StatefulWidget {
  ...
  GameScene({Key? key, required this.gridInfo, required this.walls})
      : super(key: key);
